...
const translations = {
    ua: {
        ...
        Ipsum.`,
            ...
            faqList: [
                {
                    title: "Курс проходить онлайн?",
                    description:
                        "Так, курс проходитиме онлайн. Комунікація вівдуватиметься в Телеграм, а заняття будуть проходити на платформі Google Meet.",
                },
                {
                    title: "Чи є пробний урок?",
                    description:
                        "Ні, пробного заняття курсу немає. Але на першій онлайн зустрічі з тобою буде ментор курсу та ще хтось з команди. Так, ми зрозуміємо твої поточні навички і будемо розуміти над чим тобі потрібно працювати.",
                },
                {
                    title: "Скільки людей в одній групі?",
                    description: "До 4-ох людей.",
                },
                {
                    title: "Чи можна відпрацювати пропущене заняття?",
                    description:
                        "Через те, що заняття мають послідовну програму, віпрацювати його не можна. Але можна переглянути усі онлайн-матеріали пропущеного заняття самостійно і задати питання ментору.",
                },
            ],
        },
    },
