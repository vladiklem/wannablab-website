        ...
        <div className={cx(styles.container, "container pt-4")}>
            ...
            >
                <div className="flex-grow-1">
                    {testItem.audio && (
                        <div>
                            <h1 class="h3 mb-3 text-highlighted">{testItem.audio.description}</h1>
                            <audio class="mb-4" preload="auto" controls>
                                <source src={testItem.audio.source} />
                            </audio>
                        </div>
                    )}
                    {testItem.text && <p>{testItem.text}</p>}
                    ...
                    <div className="mb-3">
                        ...
                        >
                            ...
                            <h3 className="regular">
                                Стоп-стоп-стоп. Ти можеш зателефонувати самостійно прямо зараз і
                                отримати <span className="font-weight-semibold">знижку 10%</span> на
                                всі наші курси та плани.
                                <br /> Тисни <a href="tel:+380982864800">+380982864800</a> 😉
                            </h3>
                        </div>
                    </div>
                </div>
