                        ...
                        <div>
                            <p>
                                ...
                                <img
                                    ...
                                    className={styles.sectionImageRight}
                                />
                                Перші 40 хвилин заняття - найпродуктивніші. В цей час мозок працює
                                дуже активно: запам'ятовує інформацію, будує логічні і асоціативні
                                ланцюжки, відмінно сприймає нюанси і відтінки мови. Після 80 хвилин
                                занять він працюватиме на 50% своїх можливостей. Заняття раз на
                                тиждень не дозволяють мозку сформувати стійкі осередки пам'яті, а за
                                тиждень без занять ти бдуеш втрачати до 80% вивченої інформації.
                            </p>
                            <p>
